...
img=Image.open("New Picture.png")
...
def analysis():
    ...
    for num, data in enumerate(verify_data):
        ...
        c=np.argmax(model_out)
        print(c)
        if c == 0:
            str_label = 'Parkinson is not affected'
        elif c == 1:
            str_label = 'Parkinson is affected'
...
def openphoto():
    ...
    title.destroy()
##    button1.destroy()
    button2 = tk.Button(text="Analyse Image", command=analysis, background = "black", fg="white", font=("times", 18))
